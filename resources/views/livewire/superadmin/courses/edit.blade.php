<x-app-layout>
    <div class="container">
        ...
        <form wire:submit.prevent="updateCourse" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" wire:model="new_course_image">
                ...
                @error('new_course_image') <span class="text-danger">{{ $message }}</span> @enderror
            </div>
