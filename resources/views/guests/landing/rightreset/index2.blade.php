    ...
    <section class="section bg-light">
        <div class="container">
            ...
            <p class="text-center " style="font-size: 23px">
                Join the Right Reset masterclass on <strong class="text-success"> August 9th, by 8pm, </strong> where
  ...
  <div class="container">
    <div class="d-flex justify-content-center">
      <div class="card shadow" style="max-width: 400px; width: 100%;">
       ...
       <div class="mastertext-center d-flex justify-content-center mt-4">
                <a href="https://paystack.com/buy/rightreset-hxvysh" class="btn btn-primary">Join the Masterclass now with just
    ...
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <div class="text-center mt-4">
                <a href="https://paystack.com/buy/rightreset-hxvysh" class="btn btn-primary">Be the Next Testifier!</a>
            </div>
        </div>
    </section>
  ...
  <div class="d-inline-flex align-items-center gap-3 bg-light p-3 rounded shadow-sm">
    ...
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <div class="text-center mt-5">
                <a href="https://paystack.com/buy/rightreset-hxvysh" class="mastersection-title ">Don't miss the slot,
                    Pay Now!</a>
            </div>
        </div>
    </section>
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="text-center mt-4">
                <a href="https://paystack.com/buy/rightreset-hxvysh" class="btn btn-primary">BE THE NEXT TESTIFIER, PAY
                    NOW!!!
                </a>
            </div>
        </div>
            ...
            <div class="row align-items-start">
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div class="mastertext-center d-flex justify-content-center mt-4" style="margin-bottom: 20px;">
                        <a href="https://paystack.com/buy/rightreset-hxvysh" class="btn btn-primary">Let’s reset — the right
                            way.</a>
    ...
    <section class="py-5" style="background-color: #FFC300">
        <div class="container">
            ...
            <div class=" mastertext-center d-flex justify-content-center mt-5">
                <a href="https://paystack.com/buy/rightreset-hxvysh" class="btn btn-primary btn-lg">Yes, I Want to Pay
            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                        data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            You can register by clicking <a href="https://paystack.com/buy/rightreset-hxvysh"
...
<footer class="footer">
    <div class="container">
        <p>
            &copy; 2025 Bimbo Ilori Programs. All rights reserved.
            <span class="text-dark">
                <a href="https://bimboilori.com/">www.bimboilori.com</a>
            </span> |
...
<script>
  const targetDate = new Date("2025-08-09T20:00:00");
