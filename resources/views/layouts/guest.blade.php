...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Heebo:wght@400;500;600&family=Nunito:wght@600;700;800&display=swap" rel="stylesheet" loading="lazy">
        ...
        <div class="container-fluid">  <!-- Added container-fluid for proper spacing -->
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="{{ route('about.index') }}" class="nav-item nav-link {{ request()->routeIs('about*') ? 'active' : '' }}">About</a>
                    <a href="{{ route('courses') }}" class="nav-item nav-link {{ request()->routeIs('courses*') ? 'active' : '' }}">Courses</a>
                    <a href="{{ route('books.index') }}" class="nav-item nav-link {{ request()->routeIs('books*') ? 'active' : '' }}">Books by BI</a>
                    <a href="{{ route('testimonials.index')}}" class="nav-item nav-link {{ request()->routeIs('testimonials*') ? 'active' : '' }}">Testimonials</a>
                    <a href="{{ route('contact.index') }}" class="nav-item nav-link {{ request()->routeIs('contact*') ? 'active' : '' }}">Contact Us</a>
                </div>
                <a href="{{ route('contact.index') }}" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Contact Us<i class="fa fa-arrow-right ms-3"></i></a>
            </div>
        </div>
    </nav>
    ...
    <div class="container-fluid bg-dark text-light footer pt-5 mt-5">
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-globe me-2"></i> <a href="https://bimboilori.com" class="text-light text-decoration-none">bimboilori.com</a></p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-2"></i> <a href="tel:+2349028763627" class="text-light text-decoration-none">+234 902 876 3627</a></p>
                    <p class="mb-3"><i class="fa fa-envelope me-2"></i> <a href="mailto:iloribimbo59@gmail.com" class="text-light text-decoration-none">iloribimbo59@gmail.com</a></p>
                    <div class="d-flex pt-3">
                        <a class="btn btn-outline-light btn-social me-2" href="https://www.instagram.com/bimboilori_bi"><i class="fab fa-instagram"></i></a>
                        <a class="btn btn-outline-light btn-social me-2" href="https://www.facebook.com/bimbo.a.ilori?mibextid=ZbWKwL"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-outline-light btn-social me-2" href="https://creators.spotify.com/pod/show/bimbo-ilori"><i class="fab fa-spotify"></i></a>
                        <a class="btn btn-outline-light btn-social" href="https://www.linkedin.com/in/bimbo-iiori"><i class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p>Stay updated with the latest news and insights from bimboilori.com.</p>
                    <div class="position-relative mx-auto" style="max-width: 100%;">
                        <input class="form-control border-0 w-100 py-3 ps-4 pe-5 rounded" type="email" placeholder="Enter your email">
                        <button type="button" class="btn btn-primary position-absolute top-0 end-0 mt-2 me-2 px-4">Sign Up</button>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="copyright text-center py-3 border-top">
                <p class="mb-0">&copy; <a class="text-light text-decoration-none" href="https://bimboilori.com">bimboilori.com</a>. All Rights Reserved.</p>
            </div>
        </div>
    </div>
